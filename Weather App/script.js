...
function weather(data){
    ...
    switch(data.weather[0].main){
        case 'Haze':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/mist.png');
            break;
        case 'Clouds':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/clouds.png');
            break;
        case 'Snow':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/snow.png');                
            break;
        case 'Clear':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/clear.png');
            break;
        case 'Rain':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/rain.png');
            break;      
        case 'Drizzle':
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/drizzle.png');
            break;
        default:
            document.querySelector(".content img").setAttribute("src",'C:/Users/ACER/Downloads/iSuyash-webDev-main/iSuyash-webDev-main/Weather App/images/clouds.png');
            break;
